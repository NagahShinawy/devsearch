...
# # # ################## #################  # #################  # #################  # #################
# Working with ModelManager

projects = Project.objects.all()

print(projects)

by_owner = Project.objects.get_by_developer("joHN")

print(by_owner)

by_tag = Project.objects.get_by_tag("fastAPi")

print(by_tag)


by_title = Project.objects.get_by_title("Oo")
